...
if __name__ == '__main__':
    create_tfrecord('./train/', "./tfrecord/number_10_train.tfrecords")
    create_tfrecord('./test/', "./tfrecord/number_10_test.tfrecords")
    create_tfrecord('./validation/', "./tfrecord/number_10_validation.tfrecords")